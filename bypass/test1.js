 ...
 // ... (পূর্বের কোডের অংশ)
  ...
  function _0x171374(_0x2cf0b9) {
    ...
    document.getElementById("target-aincrad33").addEventListener("click", async function () {
      if (!_0x46a3ae || !_0xcheckKey()) return;
