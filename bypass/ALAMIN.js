(function () {
  ...
  let _0x45d580 = {
    status: 1,
    musicListUrl: "https://raw.githubusercontent.com/INGRANTED/1/refs/heads/main/bypass/assets/music.txt",
    apiBaseUrl: "https://lol.a2mbd3.workers.dev",
    apiKey: "abdullah",
    totpSecret: "JBSWY3DPEHPK3PXP",
    fallbackRedirectUrl: "https://raw.githubusercontent.com/INGRANTED/1/refs/heads/main/bypass/index.html",
  ...
  async function _0x271f92() {
    ...
    try {
      const _0x2847c = await fetch("https://raw.githubusercontent.com/INGRANTED/1/refs/heads/main/bypass/assets/data.json;
      if (!_0x2847c.ok) {
  ...
  async function _0x130b6b() {
    ...
    try {
      const _0x4e096c = await fetch("https://raw.githubusercontent.com/INGRANTED/1/refs/heads/main/bypass/assets/users.json?t=" + Date.now());
      if (!_0x4e096c.ok) {
        _0x5d0f98.log("USERS", "Failed, status: " + _0x4e096c.status);
        return;
      }
      const _0x4a1a85 = await _0x4e096c.json();
      _0x5d0f98.log("USERS", "Loaded, total: " + (_0x4a1a85.users?.length || 2));
